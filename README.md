...
```
Copyright © 2021-present Ronaldson Bellande, Bellande Architecture Mechanism Research Innovation Center. All rights reserved.
...
1. Research Data and Findings: All experimental data, research outcomes, and scientific findings, whether published or unpublished, are proprietary to Bellande Architecture Mechanism Research Innovation Center.
...
Restricted Actions:
No part of these Materials may be reproduced, distributed, modified, reverse engineered, decompiled, analyzed for structure, displayed, performed, published, transmitted, or used in any form or by any means, including photocopying, recording, or other electronic or mechanical methods, without the prior written permission of Bellande Architecture Mechanism Research Innovation Center, except for:
(a) uses explicitly permitted under a separate written agreement with Bellande Architecture Mechanism Research Innovation Center,
...
Any authorized use of the Materials must be accompanied by appropriate attribution to Bellande Architecture Mechanism Research Innovation Center and relevant researchers/authors as specified in the citation guidelines.
...
All trademarks, service marks, trade names, and patents referenced or embodied in the Materials are proprietary to Bellande Architecture Mechanism Research Innovation Center or their respective owners.
